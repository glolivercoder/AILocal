...
class AudioControlDialog(QDialog):
    ...
    def init_ui(self):
        ...
        input_device_layout = QVBoxLayout()
        input_device_frame.setLayout(input_device_layout) # <-- Adicionei esta linha
        ...
        output_device_frame.setLayout(output_device_layout) # <-- Adicionei esta linha
